...
void initapp()
{
	...
	//PyModule_AddIntConstant(poModule, "LOCALE_SERVICE_EUROPE", 0);
	//PyModule_AddIntConstant(poModule, "LOCALE_SERVICE_SINGAPORE", 0);
	PyModule_AddIntConstant(poModule, "LOGIN_COUNT_DOWN_UI_MODIFY", 0);
	PyModule_AddIntConstant(poModule, "LOGIN_TYPE_STEAM", 0);
