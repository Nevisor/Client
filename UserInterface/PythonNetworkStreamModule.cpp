...
PyObject* netGetLoginID(PyObject* poSelf, PyObject* poArgs) //OFFICIAL_UI
{
	CPythonNetworkStream& rkNetStream = CPythonNetworkStream::Instance();
	return Py_BuildValue("s", rkNetStream.GetAccountName());
}
...
void initnet()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "GetLoginID",							netGetLoginID,							METH_VARARGS }, //NEW_SELECT_WINDOW
