...
PyObject * chatSetChatFilter(PyObject* poSelf, PyObject* poArgs)
{
	int iID, iType, iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iID))
		return Py_BuildException();
	...
	CPythonChat::Instance().SetChatFilter(iID, iType, iFlag);
...
void initChat()
{
	static PyMethodDef s_methods[] = 
	{
		...
		{ "SetChatFilter",			chatSetChatFilter,			METH_VARARGS },
