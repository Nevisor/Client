...
class CPythonEventManager : public CSingleton<CPythonEventManager>
{
	...
	public:
		...
		{
			int iTotalLineCount; //OFFICIAL_UI
	...
	public:
		...
		int GetTotalLineCount(int iIndex); //NEW

		void SetVisibleLineCount(int iIndex, int iLineCount); //NEW
		void SetVisibleFontColor(int iIndex, float fr, float fg, float fb); //NEW
