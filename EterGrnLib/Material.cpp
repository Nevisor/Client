...
void CGrannyMaterial::__ApplyDiffuseRenderState()
{
	...
	if (m_bTwoSideRender)
	{
		// -_-·»´ő¸µ ÇÁ·ÎĽĽ˝ş°ˇ Á» ±¸·ÁĽ­... Save & Restore ÇĎ¸é ĽřĽ­¶§ą®żˇ Á» ˛żŔÎ´Ů. ±ÍÂúŔ¸´Ď Save & Restore ´ë˝Ĺ µű·Î ŔúŔĺÇŘ µŇ.
...
{
	// NOTE - BlendingÇŘĽ­ Âď´Â şÎşĐŔş Specular¸¦ Ŕűżë˝ĂĹ°Áö ľĘ´Â´Ů - [levites]
